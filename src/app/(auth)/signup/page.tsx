...
export default function SignUp() {
    ...
    return (
        <div className='w-full h-screen bg-cover flex justify-center items-center relative'>
            ...
            <form onSubmit={handleSignUp} className='w-[90%] h-[600px] max-w-[500px] bg-[#00000069] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px]'>
